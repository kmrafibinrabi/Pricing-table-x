...
class vxpt_PriceTable extends vxpt_Type
{
     ...
     * @return vxpt_PriceTable
     * @throws Exception
     */
    public static function createFromArray(array $price_table_data): vxpt_PriceTable
    {
        ...
        if (is_array($price_table_data['fields'])) {
            foreach ($price_table_data['fields'] as $key => $cols) {
                ...
                $column_array[] = vxpt_Column::createFormArray($cols);
            }
        }
        return new vxpt_PriceTable($price_table_id, $pricing_table_title, $template_id, $custom_styles, $column_array);
    }
}