...
class vxpt_Feature extends vxpt_Type
{
     ...
     * @throws Exception
     */
    public static function createFromArray(array $feature_data_array): vxpt_Feature
    {
        ...
        return new vxpt_Feature($feature_text, $feature_checked, $fid, $sort_value);
    }
}